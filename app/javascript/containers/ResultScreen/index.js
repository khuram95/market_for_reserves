...
const ResultScreen = ({ classes, answers, setAnswers, setCurrentScreen }) => {
  ...
  return (
    ...
    >
      {!showStudentName &&
        <Grid className={classes.leftBarContainer}>
          ...
          <Grid className={classes.forTeachers}>
            ...
            <Link href="https://mru.org/supplydemand" target="_blank" className={classes.sideBarLink}>
              <img src={Blocks} className={classes.linkImg} />
              <Grid>
                <Typography className={classes.sideBarLinkText}>UNIT PLAN</Typography>
                <Typography className={classes.sideBarLinkText}>Supply and Demand</Typography>
              </Grid>
            </Link>
            <Link href="https://mru.org/resources/high-school/interactive-practice" target="_blank" className={classes.sideBarLink}>
              <img src={Hand} className={classes.linkImg} />
              <Grid>
                <Typography className={classes.sideBarLinkText}>MORE INTERACTIVE</Typography>
                <Typography className={classes.sideBarLinkText}>PRACTICE</Typography>
              </Grid>
            </Link>
            <Link href="https://mru.org/high-school-teaching-resources" target="_blank" className={classes.sideBarLink}>
              <img src={Desk} className={classes.linkImg} />
              <Grid>
                <Typography className={classes.sideBarLinkText}>ALL HIGH SCHOOL</Typography>
                <Typography className={classes.sideBarLinkText}>RESOURCES</Typography>
              </Grid>
            </Link>
            <Link href="https://mru.org/university-teaching-resources" target="_blank" className={classes.sideBarLink}>
              <img src={Podium} className={classes.linkImg} />
              <Grid>
                <Typography className={classes.sideBarLinkText}>ALL UNIVERSITY</Typography>
                <Typography className={classes.sideBarLinkText}>RESOURCES</Typography>
              </Grid>
            </Link>
          </Grid>
      ...
      <Grid container alignItems='center' direction='column' className={classes.quizResultContainer}>
        <Grid>
      ...
      <Grid container className={classes.mruLogoContainer}>
        <Grid container justify="flex-end">
          <Link href="https://mru.org" target="_blank" className={classes.mruLogo}>
