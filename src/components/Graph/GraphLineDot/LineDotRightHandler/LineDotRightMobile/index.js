...
const LineDotRightMobile = (props) => {
  ...
  const p1ToCorrect = () => answer.includes('up') ? (dotCenterPosition - 34) - 5 : (dotCenterPosition - 34) + 50
    ...
    <div>
      {showDottedLines &&
        <RightLabels
          ...
          dotCorrectQ={{
            top: answer.includes('up') ? (dotCenterPosition - 25) - 8 : (dotCenterPosition - 25) + 48,
            left: q2ToCorrect()
          }}
          isMobile={true}
          isEmulator={false}
