...
const SupplyCurve = (props) => {
  ...
  const showArrow = () => {
    switch (answer) {
      case "Supply curve shifts left":
        ...
        setArrowPosition({ top: dotCenterPosition - 150, left: -40 })
        break;
      case "Supply curve shifts right":
        setArrowPosition({ top: dotCenterPosition - 150, left: 15 })
  ...
  const p2ToOrigin = () => dotCenterPosition - 65
  ...
  return (
    <div>
       {showDottedLines &&  questionAnswer.type === "limited" &&
          <Labels
          p2Top={p2ToOrigin()}
          p1Top={p1ToCorrect()}
