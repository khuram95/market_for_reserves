...
const SupplyCurveMob = (props) => {
  ...
  const showArrow = () => {
    switch (answer) {
      case "Supply curve shifts left":
        ...
        setArrowPosition({ top: 122, left: -52 });
        break;
      case "Supply curve shifts right":
        setArrowPosition({ top: 50, left: 51 });
  ...
  const setColors = () => {
    if (disableDemand) setLineColor("red");
  };
            ...
            <div className={classes.lineContainer} id="draggable_line">
              ...
              >
                ...
                {lineMovedOrNotAnswered() && (
                  <img
                    src={changeIconColor && answeredCorrectly ? S2 : sBlue}
...
export default withStyles(styles)(SupplyCurveMob);
